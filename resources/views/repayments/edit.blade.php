      ...
      <!-- Title -->
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Edit Repayment - {{ $repayment->id }}</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
              {!! Breadcrumbs::render('repayments.edit', $repayment->id) !!}
          </div>
          <!-- /Breadcrumb -->
       </div>
       <!-- /Title -->
                              ...
                              <div class="panel-body">               
                                 ...
                                 <div class="form-wrap">
                                    ...
                                    <form class="form-horizontal" method="POST" 
                                        action="{{ route('repayments.update', $repayment->id) }}"> 
                                        ...
                                        <div  class="form-group{{ $errors->has('comment') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-sm-9">
                                              ...
                                              <textarea 
                                                  ...
                                                  class="form-control" 
                                                  id="comment" 
                                                  name="comment">{{ $repayment->comment }}</textarea>
