...
@section('title')
    ...
    Create New Mpesa C2B Transaction
      ...
      <!-- Title -->
       <div class="row heading-bg">
          <div class="col-sm-6 col-xs-12">
            <h5 class="txt-dark">Create New Mpesa C2B Transaction</h5>
          </div>
          <!-- Breadcrumb -->
          <div class="col-sm-6 col-xs-12">
                        ...
                        <div class="panel panel-default card-view">
                           ...
                           <div class="panel-wrapper collapse in">
                              ...
                              <div class="panel-body">               
                                 ...
                                 <div class="mb-30">
                                    <h3 class="text-center txt-dark mb-10">Create New Mpesa C2B Transaction</h3>
                                 </div>   
