	    ...
	    <div class="chat_container">
	            ...
	            <div class="row">
	                <div id="custom-search-input">
	                    <div class="input-group col-md-12">
	                        <input type="text" class="  search-query form-control" placeholder="Find User Conversation" />
	        ...
	        <div class="col-sm-8 message_section">
	            ...
	            <div class="row">
                    ...
                    <chat-add-widget></chat-add-widget>
...
<script>
	...
	import ChatAddWidget from './ChatAddWidget.vue';
