<template>
    ...
    <div class="wrapper theme-1-active pimary-color-red">
        ...
        <app-settings-right></app-settings-right>

        <app-sidebar-backdrop-right></app-sidebar-backdrop-right>
...
<script>
    ...
    import SidebarLeft from './../includes/SidebarLeft.vue';
    import SidebarRight from './../includes/SidebarRight.vue';
    import SettingsRight from './../includes/SettingsRight.vue';
    import SidebarBackdropRight from './../includes/SidebarBackdropRight.vue';
    ...
    export default {
        ...
        components: {
            ...
            appSettingsRight: SettingsRight,
            appSidebarBackdropRight: SidebarBackdropRight
        }
