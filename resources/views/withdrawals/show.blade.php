                                    ...
                                    <div class="follo-data">
                                      <div class="user-data">
                                        <span class="name block">
                                            ...
                                            {{ format_num($withdrawal->user->account_balance) }}
                                        </span>
                                      </div>
                                      <div class="clearfix"></div>
                                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12">
                          ...
                          <ul class="list-icons">
                              ...
                              <li class="mb-20">
                                  <strong>Last Created By: </strong> 
                                  {{ $withdrawal->creator->first_name }}
                                  {{ $withdrawal->creator->last_name }}
                              </li>
                              ...
                              <li class="mb-20">
                                  ...
                                  {{ $withdrawal->updater->first_name }}
                                  {{ $withdrawal->updater->last_name }}
                              </li>
