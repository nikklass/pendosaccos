            ...
            <div class="nav-header pull-left">
               <div class="logo-wrap">
                   ...
                   <router-link :to="{ name: 'home' }" >
                       <a>
                          <img class="brand-img mr-10" src="/css/images/logo.png" alt="QLoans"/>
                          <span class="brand-text">QuickLoans</span>
                       </a>
                   </router-link>
               ...
               <li class="dropdown alert-drp">
                 ...
                 <li class="dropdown auth-drp">
                    <a href="#" class="dropdown-toggle pr-0" data-toggle="dropdown">
                        <img src="/css/images/user1.png" :alt="authUserStore.authUser.first_name" class="user-auth-img img-circle"/>
                        <span class="user-online-status"></span>
                    </a>
                    <ul class="dropdown-menu user-auth-dropdown" data-dropdown-in="flipInX" data-dropdown-out="flipOutX">
                       <li>
                          <a href="profile.html" class="dropdown-toggle pr-0 level-2-drp">
                              <i class="zmdi zmdi-check text-info"></i> 
                              {{ authUserStore.authUser.first_name }} 
                          </a>
                       </li>
                       <li class="divider"></li>
                       <li>
                       ...
                       <li>
                          <a href="#"><i class="zmdi zmdi-card"></i><span>My Account</span></a>
                       </li>
                       <li>
                       ...
                       <li class="divider"></li>
                       <li class="link" @click="handleLogout()">
